(function (global) {
  function moduleDefinition(angular, ngParse) {
  ...
  // define(['angular', 'ngParse'], moduleDefinition);
  if (typeof exports === 'object') {
    module.exports = moduleDefinition(require('angular'));
  } else if (typeof define === 'function' && define.amd) {
    define([], moduleDefinition);
  } else {
    global.definejs = moduleDefinition(angular);
  }
})(function () {
  return this;
}());